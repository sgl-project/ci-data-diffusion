...
*Generated: Aug 04 | Commit: `34af3ff`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **qwen_image_2512_t2i_1024** (sglang): 8.86s -> 10.65s (+20.2%)
> - **ltx2.3_twostage_ti2v_2gpus** (sglang): 14.07s -> 16.07s (+14.2%)
> - **wan22_i2v_a14b_720p** (sglang): 202.65s -> 216.79s (+7.0%)
...
| FLUX.1-dev | ✅ | **4.85** |
| FLUX.2-dev | ✅ | **14.46** |
| Qwen-Image-2512 | ✅ | **10.65** |
| Qwen-Image-Edit-2511 | ✅ | **15.77** |
| Z-Image-Turbo | ✅ | **0.83** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | **209.72** |
| Wan2.2-TI2V-5B-Diffusers | ✅ | **64.20** |
| LTX-2.3 | ✅ | **16.07** |
| ideogram-4-fp8 | ✅ | **5.36** |
| Cosmos3-Super | ✅ | **115.40** |
| Wan2.2-I2V-A14B-Diffusers | ⚠️ | **216.79** |
...
| Jul 01 | `5b76f55` | 4.85 | 15.09 | 12.91 | 23.97 | 1.45 | 210.75 | 65.19 | 16.07 | 5.35 | 115.37 | 204.71 | -- |

> [!CAUTION]
> **Action Required — Performance Alert**
>
> The following cases need attention:
> - wan22_i2v_a14b_720p: SGLang regression +6.6% vs 3-run avg (216.79s vs 203.37s)
