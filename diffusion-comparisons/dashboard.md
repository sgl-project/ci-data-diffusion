...
*Generated: Sep 23 | Commit: `172b1b4`*
...
> - **MiniMax-H3**: 2/3 server samples available
...
|-------|------|----------------|----------------|---------|
| FLUX.1-dev | ✅ | 3 | 3/3 | **4.62** |
| FLUX.2-dev | ✅ | 3 | 3/3 | **13.35** |
| Qwen-Image-2512 | ✅ | 3 | 3/3 | **8.40** |
| Qwen-Image-Edit-2511 | ✅ | 3 | 3/3 | **14.92** |
| Z-Image-Turbo | ✅ | 3 | 3/3 | **0.77** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | 3 | 3/3 | **207.82** |
| Wan2.2-TI2V-5B-Diffusers | ✅ | 3 | 3/3 | **56.24** |
| LTX-2.3 | ✅ | 3 | 3/3 | **14.06** |
| ideogram-4-fp8 | ✅ | 3 | 3/3 | **3.84** |
| Cosmos3-Super | ✅ | 3 | 3/3 | **119.44** |
| Wan2.2-I2V-A14B-Diffusers | ✅ | 3 | 3/3 | **201.80** |
| MiniMax-H3 | ✅ | 3 | 2/3 | **78.29** |

## SGLang Server-Side Breakdown

| Model | Server total (s) | Text encode (s) | Denoise (s) | Decode (s) | Median denoise step (ms) |
|-------|------------------|-----------------|--------------|------------|---------------------------|
| FLUX.1-dev | 4.32 | 0.04 | 4.11 | 0.02 | 83.04 |
| FLUX.2-dev | 13.22 | 0.36 | 12.40 | 0.01 | 247.37 |
| Qwen-Image-2512 | 8.31 | 0.23 | 8.00 | 0.06 | 161.00 |
| Qwen-Image-Edit-2511 | 14.85 | N/A | 14.06 | 0.10 | 353.35 |
| Z-Image-Turbo | 0.64 | 0.13 | 0.49 | 0.01 | 56.77 |
| Wan2.2-T2V-A14B-Diffusers | 206.67 | 0.23 | 203.82 | 2.28 | 5093.87 |
| Wan2.2-TI2V-5B-Diffusers | 54.19 | 0.33 | 48.31 | 5.50 | 973.86 |
| LTX-2.3 | 12.21 | 0.40 | 8.80 | 1.01 | 292.73 |
| ideogram-4-fp8 | 3.74 | 0.13 | 3.52 | 0.09 | 178.69 |
| Cosmos3-Super | 118.06 | 0.00 | 115.13 | 2.38 | N/A |
| Wan2.2-I2V-A14B-Diffusers | 201.16 | 0.23 | 195.28 | 2.20 | 4877.39 |
| MiniMax-H3 | 76.47 | 0.05 | 73.80 | 1.31 | 1531.67 |
...
|------|--------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|-------|
| Sep 23 | `172b1b4` | 4.62 | 13.35 | 8.40 | 14.92 | 0.77 | 207.82 | 56.24 | 14.06 | 3.84 | 119.44 | 201.80 | 78.29 |            |
...
| Aug 08 | `3a5720d` | 4.71 | 14.65 | 11.42 | 15.77 | 0.79 | 286.79 | 64.19 | 17.08 | 5.40 | 115.29 | 201.74 | N/A | -- |
